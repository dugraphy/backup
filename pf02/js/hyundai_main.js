...
$(window).width(function() {
  ...
  function hasScrolled() {
     ...
     if (st < 0) {
        $('.normal-header').removeClass('nav-down').removeClass('nav-up').removeClass('nav-hover-out');
     } else if (st > lastScrollTop && st > 0) {
        // Scroll Down
        $('.normal-header').removeClass('nav-down').addClass('nav-up').removeClass('nav-hover-out');
     } else {
        // Scroll Up
        $('.normal-header').removeClass('nav-up').addClass('nav-down').removeClass('nav-hover-out');
     }
     lastScrollTop = st;
  }
});
